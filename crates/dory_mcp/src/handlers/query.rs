use dory_core::{QueryLanguage, classify_query_for_governance};
use dory_policy::{ExecutionClassification, PolicyDecision, PolicyEngine, PolicyEvaluationRequest};
use thiserror::Error;
...
pub enum QueryHandlerError {
    ...
    Policy(#[from] dory_policy::PolicyEngineError),
}
