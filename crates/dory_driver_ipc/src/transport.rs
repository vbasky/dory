...
impl RpcClient {
    ...
    pub fn plan_semantic_request(
        &self,
        session_id: Uuid,
        request: dory_core::SemanticRequest,
    ) -> Result<dory_core::SemanticPlan, RpcError> {
        ...
        match body {
            ...
            DriverResponseBody::Error(error) => match error.code {
                dory_ipc::driver_protocol::DriverRpcErrorCode::UnsupportedMethod => {
    ...
    pub fn schema(&self, session_id: Uuid) -> Result<dory_core::SchemaSnapshot, RpcError> {
    ...
    pub fn execute(
        &self,
        session_id: Uuid,
        request: &dory_core::QueryRequest,
    ) -> Result<dory_core::QueryResult, RpcError> {
        let dto = dory_ipc::driver_protocol::QueryRequestDto::from(request);
        let body = self.call(
            Some(session_id),
    ...
    pub fn execute_with_handle(
        ...
        session_id: Uuid,
        request: &dory_core::QueryRequest,
    ) -> Result<(Uuid, dory_core::QueryResult), RpcError> {
        let dto = dory_ipc::driver_protocol::QueryRequestDto::from(request);
        let body = self.call(
            Some(session_id),
    ...
    pub fn list_databases(
        &self,
        session_id: Uuid,
    ) -> Result<Vec<dory_core::DatabaseInfo>, RpcError> {
    ...
    pub fn schema_for_database(
        ...
        session_id: Uuid,
        database: &str,
    ) -> Result<dory_core::DbSchemaInfo, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn table_details(
        ...
        schema: Option<&str>,
        table: &str,
    ) -> Result<dory_core::TableInfo, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn view_details(
        ...
        schema: Option<&str>,
        view: &str,
    ) -> Result<dory_core::ViewInfo, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn browse_collection(
        &self,
        session_id: Uuid,
        request: dory_core::CollectionBrowseRequest,
    ) -> Result<dory_core::QueryResult, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn count_collection(
        &self,
        session_id: Uuid,
        request: dory_core::CollectionCountRequest,
    ) -> Result<u64, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn explain(
        &self,
        session_id: Uuid,
        request: dory_core::ExplainRequest,
    ) -> Result<dory_core::QueryResult, RpcError> {
    ...
    pub fn describe_table(
        &self,
        session_id: Uuid,
        request: dory_core::DescribeRequest,
    ) -> Result<dory_core::QueryResult, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn update_row(
        &self,
        session_id: Uuid,
        patch: dory_core::RowPatch,
    ) -> Result<dory_core::CrudResult, RpcError> {
    ...
    pub fn update_document(
        &self,
        session_id: Uuid,
        update: dory_core::DocumentUpdate,
    ) -> Result<dory_core::CrudResult, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn insert_document(
        &self,
        session_id: Uuid,
        insert: dory_core::DocumentInsert,
    ) -> Result<dory_core::CrudResult, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn delete_document(
        &self,
        session_id: Uuid,
        delete: dory_core::DocumentDelete,
    ) -> Result<dory_core::CrudResult, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn schema_types(
        ...
        database: &str,
        schema: Option<&str>,
    ) -> Result<Vec<dory_core::CustomTypeInfo>, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn schema_indexes(
        ...
        database: &str,
        schema: Option<&str>,
    ) -> Result<Vec<dory_core::SchemaIndexInfo>, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn schema_foreign_keys(
        ...
        database: &str,
        schema: Option<&str>,
    ) -> Result<Vec<dory_core::SchemaForeignKeyInfo>, RpcError> {
        let body = self.call(
            Some(session_id),
    ...
    pub fn code_generators(
        &self,
        session_id: Uuid,
    ) -> Result<Vec<dory_core::CodeGeneratorInfo>, RpcError> {
...
fn validate_hello_selected_version(
    ...
    let selected_contract =
        dory_ipc::RpcApiContract::new(RpcApiFamily::DriverRpc, selected_version);
    let client_contract =
        dory_ipc::RpcApiContract::new(RpcApiFamily::DriverRpc, DRIVER_RPC_VERSION);
...
mod tests {
    ...
    use dory_ipc::driver_protocol::DriverRequestBody;
    use dory_ipc::{ProtocolVersion, driver_rpc_supported_versions, driver_socket_name};
    use std::sync::{Arc, Mutex};
    use uuid::Uuid;
    ...
    fn rpc_client_with_audit_capability_dispatches_emit_frame_to_emitter() {
        use dory_test_support::{FakeDriverAction, FakeDriverRpcConfig, FakeDriverRpcServer};
