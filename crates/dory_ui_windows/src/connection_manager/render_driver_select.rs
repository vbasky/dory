use dory_components::controls::{Button, GpuiInput, InputState};
use dory_components::icons::AppIcon;
use dory_components::primitives::{Icon, IconButton, KbdBadge, Text};
...
impl ConnectionManagerWindow {
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(
                        Text::heading(dory_i18n::t!("connection_manager.driver_select.title"))
                            .font_size(FontSizes::LG),
                    )
                    .child(div().text_size(FontSizes::SM).text_color(muted).child("·"))
                    .child(
                        Text::muted(dory_i18n::t!("connection_manager.driver_select.subtitle"))
    ...
    fn render_picker_footer(
        ...
        let cta_label = focused_driver
            ...
            .unwrap_or_else(|| dory_i18n::t!("connection_manager.driver_select.configure"));
            ...
            .child(
                div()
                    ...
                    .child(
                        Button::new(
                            "cm-driver-import",
                            dory_i18n::t!("connection_manager.driver_select.import_from_file"),
                        )
                        .small()
                    ...
                    .child(
                        Button::new(
                            "cm-driver-cancel",
                            dory_i18n::t!("connection_manager.driver_select.cancel"),
                        )
                        .small()
