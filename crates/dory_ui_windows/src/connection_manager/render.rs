...
use dory_components::typography::{Body, Headline, SubSectionLabel};
use dory_core::{FormFieldDef, FormFieldKind, FormTab};
                    ...
                    .when(show_save_checkbox && password_source_is_literal, |d| {
                        d.child(
                            div()
                                ...
                                .child(Body::new(dory_i18n::t!("connection_manager.action.save"))),
                        )
                    }),
            )
            ...
            .child(
                div()
                    ...
                    .child(self.form_field_input_inline(
                        &dory_i18n::t!("connection_manager.field.name"),
                    ...
                    .when(!validation_errors.is_empty(), |d| {
                        ...
                        d.child(
                            BannerBlock::new(
                                ...
                                dory_i18n::t!("connection_manager.banner.correct_following"),
                            )
                            .with_body(combined),
                        )
                    })
                    ...
                    .when(test_status != TestStatus::None, |d| {
                        ...
                        let banner = match test_status {
                            TestStatus::Testing => BannerBlock::new(
                                BannerVariant::Info,
                                dory_i18n::t!("connection_manager.banner.testing_connection"),
                            )
                            .with_icon(
                            ...
                            TestStatus::Failed => {
                                let message = test_error.unwrap_or_else(|| {
                                    dory_i18n::t!("connection_manager.banner.connection_failed")
                                });
                                ...
                                .with_actions(
                                    Button::new(
                                        ...
                                        dory_i18n::t!("connection_manager.action.copy"),
                                    )
                                    .ghost()
                                    .small()
                        ...
                        div()
                            ...
                            .when(!is_editing, |d| {
                                d.child(
                                    Button::new(
                                        "footer-back",
                                        dory_i18n::t!("connection_manager.action.back"),
                                    )
                                    .ghost()
                            ...
                            .child(
                                div()
                                    ...
                                    .child(
                                        Button::new(
                                            "save-connection",
                                            dory_i18n::t!("connection_manager.action.save"),
                                        )
                                        .primary()
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                Button::new(
                                    "browse-file-path",
                                    dory_i18n::t!("connection_manager.action.browse"),
                                )
                                .small()
                                .ghost()
                                .on_click(cx.listener(
...
impl Render for ConnectionManagerWindow {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let csd_title_bar = platform::render_csd_title_bar(
            window,
            cx,
            &dory_i18n::t!("connection_manager.window_title"),
        );
