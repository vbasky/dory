...
use dory_ui_base::{AppStateEntity, platform};
use gpui::*;
    ...
    S: FnOnce(&Entity<SettingsCoordinator>, &mut App) + 'static,
{
    ...
    let mut options = WindowOptions {
        ...
        titlebar: Some(TitlebarOptions {
            title: Some(dory_i18n::t!("connection_manager.tab.settings").into()),
            ..Default::default()
        }),
...
mod window_title_i18n_tests {
    ...
    fn settings_window_title_key_resolves_in_both_locales() {
        for locale in ["en", "es"] {
            let value = dory_i18n::t!("connection_manager.tab.settings", locale = locale);
