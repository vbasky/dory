...
impl ServicesSection {
    pub(super) fn new(
        ...
        let input_svc_command =
            cx.new(|cx| InputState::new(window, cx).placeholder("dory-driver-host"));
            ...
            .when(show_svc_delete, |element| {
                ...
                element.child(
                    Dialog::new(window, cx)
                        .title(dory_i18n::t!("settings.rpc_services.delete_dialog_title"))
                        .confirm()
...
mod tests {
    ...
    fn services_delete_dialog_title_differs_between_locales() {
        let english = dory_i18n::t!("settings.rpc_services.delete_dialog_title", locale = "en");
        let spanish = dory_i18n::t!("settings.rpc_services.delete_dialog_title", locale = "es");
