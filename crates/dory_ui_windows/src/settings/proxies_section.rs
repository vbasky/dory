...
use dory_components::controls::{GpuiInput as Input, InputEvent, InputState};
...
use dory_core::{ProxyKind, ProxyProfile};
    ...
    pub(super) fn new(
        ...
        let input_proxy_name = cx.new(|cx| {
            InputState::new(window, cx)
                .placeholder(dory_i18n::t!("settings.proxies.placeholder_name"))
        });
        ...
        let input_proxy_username = cx.new(|cx| {
            InputState::new(window, cx)
                .placeholder(dory_i18n::t!("settings.proxies.placeholder_username"))
        });
        let input_proxy_password = cx.new(|cx| {
            InputState::new(window, cx)
                .placeholder(dory_i18n::t!("settings.proxies.placeholder_password"))
                .masked(true)
        });
    ...
    fn render_proxy_kind_selector(
        ...
        let kinds = [
            (
                ...
                ProxyKind::Http,
                dory_i18n::t!("settings.proxies.kind.http"),
            ),
            (
                ProxyFormField::KindHttps,
                ProxyKind::Https,
                dory_i18n::t!("settings.proxies.kind.https"),
            ),
            (
                ProxyFormField::KindSocks5,
                ProxyKind::Socks5,
                dory_i18n::t!("settings.proxies.kind.socks5"),
            ),
        ];
        ...
        div()
            ...
            .flex_col()
            .gap_2()
            .child(Label::new(dory_i18n::t!("settings.proxies.field.protocol")))
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                div()
                                    .text_sm()
                                    .child(dory_i18n::t!("settings.proxies.auth.none")),
                            ),
                    )
                    .child(
                        div()
                            ...
                            .child(
                                div()
                                    .text_sm()
                                    .child(dory_i18n::t!("settings.proxies.auth.basic")),
                            ),
                    ),
            )
    }
    ...
    fn render_proxy_auth_fields(
            ...
            Some(
                div()
                    ...
                    .child(
                        div()
                            .text_sm()
                            .child(dory_i18n::t!("settings.proxies.action.save")),
                    ),
            )
        } else {
            None
        ...
        div()
            ...
            .child(self.render_proxy_field(
                &dory_i18n::t!("settings.proxies.field.username"),
                    ...
                    .child(
                        div()
                            ...
                            .child(div().flex_1().child(self.render_proxy_field(
                                &dory_i18n::t!("settings.proxies.field.password"),
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                Button::new("new-proxy", dory_i18n::t!("settings.proxies.new"))
                    ...
                    .child(
                        Button::new(
                            "import-proxy",
                            dory_i18n::t!("settings.proxies.action.import"),
                        )
            ...
            .child(
                div()
                    ...
                    .when(proxies.is_empty(), |root: Div| {
                        root.child(
                            div().p_4().child(
                                Body::new(dory_i18n::t!("settings.proxies.empty"))
                                    .color(theme.muted_foreground),
                            ),
                        )
                    })
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .when(!proxy.enabled, |root| {
                                                root.child(MonoCaption::new(dory_i18n::t!(
    ...
    fn render_proxy_form(
        ...
        layout::sticky_form_shell(
            PanelTitle::new(layout::editor_panel_title(
                &dory_i18n::t!("settings.proxies.panel_title"),
                editing_id.is_some(),
            )),
            div()
                .flex()
                ...
                .gap_4()
                .child(self.render_proxy_field(
                    &dory_i18n::t!("settings.proxies.field.name"),
                ...
                .child(
                    div()
                        ...
                        .gap_3()
                        .child(div().flex_1().child(self.render_proxy_field(
                            &dory_i18n::t!("settings.proxies.field.host"),
                        ...
                        .child(div().w(px(80.0)).child(self.render_proxy_field(
                            &dory_i18n::t!("settings.proxies.field.port"),
                ...
                .child(
                    div()
                        ...
                        .gap_1()
                        .child(self.render_proxy_field(
                            &dory_i18n::t!("settings.proxies.field.no_proxy"),
                        ...
                        .child(
                            Body::new(dory_i18n::t!("settings.proxies.hint.no_proxy_list"))
                                .color(theme.muted_foreground),
                        ),
                )
                .child({
                    ...
                    div()
                        ...
                        .child(Body::new(dory_i18n::t!("settings.proxies.field.enabled")))
                }),
            None,
            &theme,
        )
        ...
        div()
            ...
            .when(editing_id.is_some(), |root| {
                ...
                root.child(layout::footer_action_frame(
                    ...
                    Button::new(
                        "export-proxy",
                        dory_i18n::t!("settings.proxies.action.export"),
                    )
                    .small()
                    .ghost()
                    .w_full()
                ...
                .child(layout::footer_action_frame(
                    ...
                    Button::new(
                        "delete-proxy",
                        dory_i18n::t!("settings.proxies.action.delete"),
                    )
                    .small()
                    .danger()
                    .w_full()
            ...
            .child(layout::footer_action_frame(
                ...
                Button::new(
                    ...
                    if editing_id.is_some() {
                        dory_i18n::t!("settings.proxies.action.update")
                    } else {
                        dory_i18n::t!("settings.proxies.action.create")
                    },
                )
                .small()
                .primary()
    ...
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        layout::split_section_shell(
            dory_components::composites::section_header(
                dory_i18n::t!("settings.proxies.section_title"),
                dory_i18n::t!("settings.proxies.section_description"),
                cx,
            ),
        ...
        .when(show_proxy_delete, |element| {
            ...
            element.child(
                Dialog::new(window, cx)
                    .title(dory_i18n::t!("settings.proxies.delete_dialog_title"))
                    .confirm()
                    .on_ok(move |_, _, cx| {
        ...
        .when(show_discard_confirm, |element| {
            ...
            element.child(
                Dialog::new(window, cx)
                    .title(dory_i18n::t!("settings.proxies.discard_dialog_title"))
                    .confirm()
                    ...
                    .child(
                        div()
                            .text_sm()
                            .child(dory_i18n::t!("settings.proxies.discard_dialog.body")),
                    ),
            )
        })
    }
...
mod tests {
    ...
    fn proxies_section_title_differs_between_locales() {
        let english = dory_i18n::t!("settings.proxies.section_title", locale = "en");
        let spanish = dory_i18n::t!("settings.proxies.section_title", locale = "es");
    ...
    fn proxies_kind_labels_stay_untranslated_protocol_names() {
        for locale in ["en", "es"] {
            assert_eq!(
                dory_i18n::t!("settings.proxies.kind.http", locale = locale),
                "HTTP"
            );
            assert_eq!(
                dory_i18n::t!("settings.proxies.kind.https", locale = locale),
                "HTTPS"
            );
            assert_eq!(
                dory_i18n::t!("settings.proxies.kind.socks5", locale = locale),
                "SOCKS5"
            );
        }
    }
    ...
    fn proxies_auth_labels_differ_between_locales() {
        let none_en = dory_i18n::t!("settings.proxies.auth.none", locale = "en");
        let none_es = dory_i18n::t!("settings.proxies.auth.none", locale = "es");
        let basic_en = dory_i18n::t!("settings.proxies.auth.basic", locale = "en");
        let basic_es = dory_i18n::t!("settings.proxies.auth.basic", locale = "es");
