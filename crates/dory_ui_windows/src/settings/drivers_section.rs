...
use dory_components::components::form_renderer::FormRendererState;
...
fn boolean_override_items() -> Vec<DropdownItem> {
    vec![
        DropdownItem::with_value(dory_i18n::t!("settings.drivers.use_global"), "default"),
        DropdownItem::with_value(dory_i18n::t!("connection_manager.overrides.on"), "true"),
        DropdownItem::with_value(dory_i18n::t!("connection_manager.overrides.off"), "false"),
    ]
}
