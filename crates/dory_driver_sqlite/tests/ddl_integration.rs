...
use dory_core::{ConnectionProfile, DbConfig, DbDriver, DbError, IndexData, QueryRequest, Value};
use dory_driver_sqlite::SqliteDriver;
use dory_test_support::ddl_fixtures::SqliteFixtures;
use std::path::PathBuf;

fn connect_sqlite() -> Result<(Box<dyn dory_core::Connection>, SqliteDriver, PathBuf), DbError> {
...
fn cleanup_test_tables(conn: &dyn dory_core::Connection) {
