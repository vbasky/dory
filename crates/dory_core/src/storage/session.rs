...
/// Manages the `~/.local/share/dory/sessions/` directory for auto-persist.
///
...
impl SessionStore {
    pub fn new() -> Result<Self, DbError> {
        ...
        let root = data_dir.join("dory").join("sessions");
