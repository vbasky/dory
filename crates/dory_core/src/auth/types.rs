...
/// files and must not be edited in Dory. Stored profiles always have
...
pub struct AuthProfile {
    ...
    pub enabled: bool,
    /// Whether this profile is a live reflection and must not be edited in Dory.
    ///
    ...
    /// `AuthEditCapabilities.dangling_messages`. Dory core does not interpret
