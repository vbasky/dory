...
pub use dory_policy::ExecutionClassification;
...
bitflags! {
    ...
    pub struct DriverCapabilities: u64 {
        ...
        /// Driver participates in Dory's local chart-authoring flow: users
        /// commonly turn its query/metric results into `SavedChart`s and group
        /// them into `Dashboard`s persisted in Dory's own SQLite store.
        ///
