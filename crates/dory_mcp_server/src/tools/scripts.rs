...
//! the platform-specific scripts directory (~/.local/share/dory/scripts/).
//!
//! All tools use `ScriptsDirectory` from `dory_core` to manage file operations.
...
use dory_core::{QueryLanguage, QueryRequest};
use rmcp::{
    ErrorData,
...
impl DoryServer {
    ...
    async fn list_scripts_impl(
        ...
        use dory_core::ScriptsDirectory;
        ...
        let entries: Vec<ScriptEntryDto> = scripts_dir
            ...
            .filter_map(|entry| {
                ...
                match entry {
                    ...
                    dory_core::ScriptEntry::Folder { name, .. } => Some(ScriptEntryDto {
                        path: relative_path,
                        name: name.clone(),
    ...
    fn detect_execution_classification(
        ...
        use dory_core::classify_query_for_governance;
        use dory_policy::ExecutionClassification;
