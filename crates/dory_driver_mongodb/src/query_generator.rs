...
fn generate_insert(insert: &dory_core::DocumentInsert) -> String {
...
fn generate_update(update: &dory_core::DocumentUpdate) -> String {
...
fn generate_delete(delete: &dory_core::DocumentDelete) -> String {
...
mod tests {
    use super::*;
    use dory_core::{DocumentDelete, DocumentFilter, DocumentInsert, DocumentUpdate};
    ...
    use dory_core::{BoolOp, ProjectedColumn, SourceTable, VisualSortDirection};
    ...
    fn read_spec_rejects_joins() {
        use dory_core::{JoinKind, JoinOn, JoinStep};
