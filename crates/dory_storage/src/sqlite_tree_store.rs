...
//! Replaces the JSON file store at `~/.config/dory/connections_tree.json`.

use crate::error::StorageError;
use crate::repositories::connection_folders::ConnectionFoldersRepository;
use crate::sqlite;
use dory_core::{ConnectionTree, DbError, TreeLoadResult, TreeStore};
...
///
/// The tree data is stored in `dory.db` (`cfg_connection_folders` table),
