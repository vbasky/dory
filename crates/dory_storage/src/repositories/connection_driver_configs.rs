//! Repository for driver-specific connection configs in dory.db.
//!
...
use dory_core::{DbConfig, DbKind, SshAuthMethod, SshTunnelConfig};
...
mod tests {
    ...
    fn temp_repo() -> (tempfile::TempDir, ConnectionDriverConfigsRepository) {
        ...
        let repo = ConnectionDriverConfigsRepository::new(runtime.dory_db());
