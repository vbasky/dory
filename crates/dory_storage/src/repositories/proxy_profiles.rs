//! Repository for proxy profiles in dory.db.
//!
...
mod tests {
    ...
    fn temp_db(name: &str) -> std::path::PathBuf {
        std::env::temp_dir().join(format!("dory_repo_proxy_{}_{}", name, std::process::id()))
    }
    ...
    fn proxy_insert_with_auth() {
        ...
        let auth_dto = ProxyAuthDto {
            ...
            domain: None,
            password_secret_ref: Some("dory:secret:proxy:test".to_string()),
        };
