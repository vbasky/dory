...
//!
//! Persists `SchemaSnapshotRecord` from `dory_core` across two SQLite tables:
...
use dory_core::{SchemaSnapshotRecord, SnapshotDepth, TableInfo};

use crate::error::StorageError;

const DB_PATH: &str = "dory.db";
...
mod tests {
    ...
    fn sample_table(name: &str) -> TableInfo {
        TableInfo {
            ...
            columns: Some(vec![dory_core::ColumnInfo {
                name: "id".to_string(),
