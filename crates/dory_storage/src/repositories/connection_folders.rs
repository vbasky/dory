//! Repository for connection folders in dory.db.
//!
...
const ROOT_FOLDER_SENTINEL_NAME: &str = "__dory_root__";
...
impl ConnectionFoldersRepository {
    ...
    pub fn save_tree(&self, tree: &dory_core::ConnectionTree) -> Result<(), StorageError> {
        // Clear existing data
        self.clear_all()?;
        ...
        fn calculate_depth(
            node: &dory_core::ConnectionTreeNode,
            tree: &dory_core::ConnectionTree,
        ) -> i32 {
    ...
    pub fn load_tree(&self) -> Result<dory_core::TreeLoadResult, StorageError> {
        use dory_core::ConnectionTreeNode;
        use dory_core::ConnectionTreeNodeKind;

        let mut tree = dory_core::ConnectionTree::new();
...
mod tests {
    ...
    fn temp_repo() -> (tempfile::TempDir, ConnectionFoldersRepository) {
        ...
        let repo = ConnectionFoldersRepository::new(runtime.dory_db());
