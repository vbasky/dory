...
impl RpcAuthProvider {
    ...
    fn new_for_test(
        ...
        use dory_core::auth::AuthProviderCapabilities;

        Self {
            socket_id: socket_id.to_string(),
            provider_id: provider_id.to_string(),
            display_name: "Test Provider".to_string(),
            form_definition: dory_core::auth::AuthFormDef { tabs: vec![] },
...
/// Stops all auth-provider host processes started by Dory. Returns count terminated.
...
mod tests {
    ...
    use dory_core::auth::{AuthFormDef, AuthProviderCapabilities, AuthProviderLoginCapabilities};
    use dory_core::{FormFieldDef, FormFieldKind, FormSection, FormTab, RefreshTrigger};
