...
use dory_components::result_panel::{ResultPanel, SegmentPosition, ToolbarSegment};
...
fn stub_view_handle(cx: &mut App) -> dory_components::result_panel::ViewHandle {
    let focus = cx.focus_handle();
    dory_components::result_panel::ViewHandle::builder()
...
fn stub_view_handle_two_modes(cx: &mut App) -> dory_components::result_panel::ViewHandle {
    let focus = cx.focus_handle();
    dory_components::result_panel::ViewHandle::builder()
        .render(|_w, _cx| div().into_any())
        .focus({
...
fn view_handle_toolbar_segments_closure_called() {
    ...
    cx.update(|cx| {
        ...
        let focus = cx.focus_handle();
        let handle = dory_components::result_panel::ViewHandle::builder()
            .render(|_w, _cx| div().into_any())
            .focus({
                let focus = focus.clone();
                move |w, _cx| {
