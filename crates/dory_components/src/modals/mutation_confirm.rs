...
impl Render for ModalMutationConfirm {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
            ...
            Some(_) | None => {
                body = body.child(
                    div()
                        .text_size(FontSizes::XS)
                        .text_color(theme.muted_foreground)
                        .child(dory_i18n::t!("modals.mutation_confirm.sample_unavailable")),
                );
            }
        }
        ...
        let footer = div()
            ...
            .child(
                Button::new(
                    ...
                    dory_i18n::t!("modals.mutation_confirm.cancel"),
                )
            ...
            .child(
                Button::new(
                    "mutation-confirm-ok",
                    dory_i18n::t!("modals.mutation_confirm.confirm"),
                )
        ...
        ModalShell::new(
            dory_i18n::t!("modals.mutation_confirm.title"),
        ...
        if require_opt_in {
            body = body.child(
                Checkbox::new("mutation-hard-opt-in")
                    ...
                    .label(dory_i18n::t!("modals.mutation_confirm.opt_in_label"))
...
mod tests {
    ...
    fn mutation_confirm_confirm_differs_between_locales() {
        let en = dory_i18n::t!("modals.mutation_confirm.confirm", locale = "en");
        let es = dory_i18n::t!("modals.mutation_confirm.confirm", locale = "es");
