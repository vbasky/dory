...
impl ModalImportDashboard {
    pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        let input = cx.new(|cx| {
            InputState::new(window, cx)
                ...
                .line_number(true)
                .soft_wrap(true)
                .placeholder(dory_i18n::t!("modals.import_dashboard.json_placeholder"))
        });

        let name_input = cx.new(|cx| {
            InputState::new(window, cx)
                .placeholder(dory_i18n::t!("modals.import_dashboard.name_placeholder"))
        });
    ...
    fn confirm(&mut self, _window: &mut Window, cx: &mut Context<Self>) {
        ...
        if name.is_empty() {
            self.name_error = Some(dory_i18n::t!("modals.import_dashboard.name_error"));
            cx.notify();
            return;
        }
...
impl Render for ModalImportDashboard {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
                ...
                div()
                    ...
                    .child(
                        Button::new("import-dashboard-format")
                            .label(dory_i18n::t!("modals.import_dashboard.format"))
                            .small()
                    ...
                    .child(
                        Button::new("import-dashboard-compact")
                            .label(dory_i18n::t!("modals.import_dashboard.compact"))
                            .small()
                            .with_variant(ButtonVariant::Ghost)
                            .on_click(on_compact),
                    ),
                ...
                div()
                    ...
                    .child(
                        Button::new("import-dashboard-cancel")
                            .label(dory_i18n::t!("modals.import_dashboard.cancel"))
                            .on_click(on_cancel),
                    )
                    .child(
                        Button::new("import-dashboard-save")
                            .label(dory_i18n::t!("modals.import_dashboard.confirm"))
        ...
        ModalShell::new(
            dory_i18n::t!("modals.import_dashboard.title"),
...
mod tests {
    ...
    fn modal_title_matches_translated_catalog_and_diverges_by_locale() {
        let en = dory_i18n::t!("modals.import_dashboard.title", locale = "en");
        let es = dory_i18n::t!("modals.import_dashboard.title", locale = "es");
