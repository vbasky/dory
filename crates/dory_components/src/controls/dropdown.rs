...
impl Dropdown {
    ...
    pub fn new(id: impl Into<ElementId>) -> Self {
        Self {
            ...
            highlighted_index: None,
            disabled: false,
            placeholder: dory_i18n::t!("controls.dropdown.placeholder").into(),
...
mod tests {
    ...
    fn dropdown_placeholder_key_resolves() {
        let en = dory_i18n::t!("controls.dropdown.placeholder", locale = "en");
        let es = dory_i18n::t!("controls.dropdown.placeholder", locale = "es");
