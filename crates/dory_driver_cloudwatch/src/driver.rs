...
impl Connection for CloudWatchConnection {
    ...
    fn dashboard_importer(&self) -> Option<&dyn dory_core::DashboardImporter> {
        Some(&self.dashboard_importer_impl)
    }

    fn dashboard_source(&self) -> Option<&dyn dory_core::DashboardSource> {
...
impl CloudWatchConnection {
    fn event_stream_request(
        ...
        CollectionBrowseRequest {
            ...
            pagination: dory_core::Pagination::Offset {
    ...
    fn row_to_event_record(
        ...
        EventRecord {
            ...
            outcome: dory_core::EventOutcome::Success,
...
impl dory_core::LanguageService for CloudWatchLanguageService {
    fn validate(&self, _query: &str) -> ValidationResult {
        ValidationResult::Valid
    }

    fn detect_dangerous(&self, _query: &str) -> Option<dory_core::DangerousQueryKind> {
        None
    }
}
...
fn cwli_field_value(name: &str, raw: &str) -> Value {
    use dory_core::chrono::{NaiveDateTime, TimeZone, Utc};
