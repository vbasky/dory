...
use dory_core::observability::actions::MCP_REJECT_EXECUTION;
use dory_core::observability::types::{EventCategory, EventOutcome, EventRecord, EventSeverity};
...
fn appends_allow_deny_failure_and_supports_filtered_export() {
    let service = service_for_test("dory-audit-e2e.sqlite");
    ...
    service
        .record(
            ...
            .with_typed_action(dory_core::observability::actions::QUERY_EXECUTE)
    ...
    service
        .record(
            ...
            .with_typed_action(dory_core::observability::actions::QUERY_EXECUTE_FAILED)
...
fn legacy_query_preserves_oldest_first_order_for_consumers() {
    let service = service_for_test("dory-audit-legacy-order.sqlite");
