...
impl Sidebar {
    ...
    fn plan_connection_keyboard_nesting(
        ...
        if direction > 0 {
            ...
            if next_sibling.kind == dory_core::ConnectionTreeNodeKind::Folder
    ...
    fn flatten_connection_tree_order_for_selection(tree: &dory_core::ConnectionTree) -> Vec<Uuid> {
        fn walk(tree: &dory_core::ConnectionTree, parent: Option<Uuid>, out: &mut Vec<Uuid>) {
...
mod tests {
    ...
    use dory_core::{ConnectionTree, ConnectionTreeNode};
    use uuid::Uuid;
