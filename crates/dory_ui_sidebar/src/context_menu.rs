...
impl Sidebar {
    ...
    fn table_supports_transfer(&self, item_id: &str, cx: &App) -> bool {
        ...
        self.app_state
            ...
            .is_some_and(|connected| {
                connected.connection.metadata().transfer_family == dory_core::TransferFamily::Sql
            })
    }
    ...
    fn node_supports_schema_diff(&self, item_id: &str, cx: &App) -> bool {
        ...
        self.app_state
            ...
            .get(&profile_id)
            .is_some_and(|connected| {
                connected.connection.metadata().category == dory_core::DatabaseCategory::Relational
            })
    }
        ...
        match node_kind {
            SchemaNodeKind::Table | SchemaNodeKind::View => {
                ...
                if self.collection_supports_child_picker(item_id, cx) {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.browse_event_streams"),
                ...
                Self::append_menu_section(
                    ...
                    [
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.view_schema"),
                            ContextMenuAction::ViewSchema,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.refresh"),
                ...
                if !generators.is_empty() {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.generate_sql"),
                ...
                if let Some(ddl) = self.get_ddl_capabilities(item_id, cx) {
                    ...
                    if drop_allowed {
                        let label = match node_kind {
                            SchemaNodeKind::View => dory_i18n::t!("sidebar.menu.drop_view"),
                            _ => dory_i18n::t!("sidebar.menu.drop_table"),
                        };
                        Self::append_menu_section(
                            &mut items,
            ...
            SchemaNodeKind::Collection => {
                    ...
                    && self.collection_has_query_template(item_id, cx)
                {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.query_measurement"),
                    ...
                    && !self.collection_is_time_series(item_id, cx)
                {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.generate_query"),
                        ...
                        .is_some_and(|ddl| ddl.supports_drop_table)
                {
                    Self::append_menu_section(
                        ...
                        [ContextMenuItem::danger(
                            dory_i18n::t!("sidebar.menu.drop_collection"),
            ...
            SchemaNodeKind::Profile => {
                ...
                if is_connected {
                    Self::append_menu_section(
                        ...
                        [
                            ContextMenuItem::item(
                                dory_i18n::t!("sidebar.menu.disconnect"),
                    ...
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.connect"),
                ...
                Self::append_menu_section(
                    ...
                    [
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.edit"),
                            ContextMenuAction::Edit,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.duplicate"),
                            ContextMenuAction::Duplicate,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.rename"),
                            ContextMenuAction::RenameFolder,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.export_ellipsis"),
                ...
                if is_connected && self.profile_supports_import(item_id, cx) {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.import_ellipsis"),
                ...
                if is_connected && self.node_supports_schema_diff(item_id, cx) {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.compare_schema"),
                ...
                if !move_to_items.is_empty() {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.move_to"),
                ...
                let delete_label = self
                    ...
                    .unwrap_or_else(|| dory_i18n::t!("sidebar.menu.delete"));
                Self::append_menu_section(
                    &mut items,
                    [ContextMenuItem::danger(
                        delete_label,
                ...
                if is_loaded {
                    ...
                    if self.database_supports_close(item_id, cx) {
                        Self::append_menu_section(
                            &mut items,
                            [ContextMenuItem::item(
                                dory_i18n::t!("sidebar.menu.close"),
                    ...
                    if self.database_is_time_series(item_id, cx) {
                        Self::append_menu_section(
                            &mut items,
                            [ContextMenuItem::item(
                                dory_i18n::t!("sidebar.menu.new_query"),
                        ...
                        .is_some_and(|ddl| ddl.supports_drop_database)
                    {
                        Self::append_menu_section(
                            &mut items,
                            [ContextMenuItem::danger(
                                dory_i18n::t!("sidebar.menu.drop_database"),
            ...
            SchemaNodeKind::ConnectionFolder => {
                ...
                Self::append_menu_section(
                    ...
                    [
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.new_connection"),
                            ContextMenuAction::NewConnection,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.new_folder"),
            ...
            SchemaNodeKind::ScriptsFolder => {
                ...
                Self::append_menu_section(
                    ...
                    [
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.new_script_file"),
                            ContextMenuAction::NewScriptFile,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.new_script_folder"),
                ...
                Self::append_menu_section(
                    ...
                    [
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.reveal_file_manager"),
                            ContextMenuAction::RevealInFileManager,
                        ),
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.copy_path"),
            ...
            SchemaNodeKind::DashboardsFolder => {
                ...
                Self::append_menu_section(
                    &mut items,
                    [ContextMenuItem::item(
                        dory_i18n::t!("sidebar.menu.new_dashboard"),
                ...
                let can_import = parse_node_id(item_id)
                    ...
                    .is_some_and(|caps| {
                        caps.contains(dory_core::DriverCapabilities::DASHBOARD_IMPORT)
                    });
                ...
                if can_import {
                    Self::append_menu_section(
                        &mut items,
                        [ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.import_dashboard"),
            ...
            SchemaNodeKind::SavedChartsFolder => {
                vec![ContextMenuItem::item(
                    dory_i18n::t!("sidebar.menu.new_saved_chart"),
            ...
            SchemaNodeKind::DashboardItem => {
                ...
                Self::append_menu_section(
                    ...
                    [
                        ContextMenuItem::item(
                            dory_i18n::t!("sidebar.menu.rename_ellipsis"),
                ...
                Self::append_menu_section(
                    &mut items,
                    [ContextMenuItem::danger(
                        dory_i18n::t!("sidebar.menu.delete_ellipsis"),
            ...
            SchemaNodeKind::InstanceMetricLeaf => {
                ...
                Self::append_menu_section(
                    &mut items,
                    [ContextMenuItem::item(
                        dory_i18n::t!("sidebar.menu.copy_metric_id"),
            ...
            SchemaNodeKind::InstanceInspectorLeaf => {
                ...
                Self::append_menu_section(
                    &mut items,
                    [ContextMenuItem::item(
                        dory_i18n::t!("sidebar.menu.copy_inspector_id"),
                        ContextMenuAction::CopyItemId,
                    )],
                );
    ...
    fn open_child_picker(&mut self, item_id: &str, cx: &mut Context<Self>) {
        ...
        match status {
            ...
            TableDetailsStatus::NotFound => {
                self.pending_toast = Some(PendingToast {
                    message: dory_i18n::t!("sidebar.overlay.child_picker.unsupported"),
                    is_error: true,
                });
            }
        }
...
mod menu_i18n_tests {
    ...
    fn menu_open_differs_between_locales() {
        let english = dory_i18n::t!("sidebar.menu.open", locale = "en");
        let spanish = dory_i18n::t!("sidebar.menu.open", locale = "es");
    ...
    fn menu_connect_differs_between_locales() {
        let english = dory_i18n::t!("sidebar.menu.connect", locale = "en");
        let spanish = dory_i18n::t!("sidebar.menu.connect", locale = "es");
    ...
    fn menu_new_dashboard_differs_between_locales() {
        let english = dory_i18n::t!("sidebar.menu.new_dashboard", locale = "en");
        let spanish = dory_i18n::t!("sidebar.menu.new_dashboard", locale = "es");
