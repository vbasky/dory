...
//! wizard (`dory_ui_document::export_wizard`) pre-populated with them.
...
//! (`dory_ui_document::export_wizard::run`).

use crate::*;
use dory_core::TransferFamily;
...
impl Sidebar {
    ...
    pub(crate) fn request_export_wizard(&mut self, item_id: &str, cx: &mut Context<Self>) {
        ...
        if resolution.skipped_other_profile_or_database > 0 {
            dory_ui_base::toast::Toast::warning(crate::labels::skipped_tables_label(
