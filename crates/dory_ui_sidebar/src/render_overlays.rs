            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .child(dory_i18n::t!("sidebar.overlay.add_folder")),
                ),
        )
        .child(
            div()
                ...
                .child(
                    div()
                        ...
                        .child(dory_i18n::t!("sidebar.overlay.add_connection")),
                ),
        )
    }
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .child(dory_i18n::t!("sidebar.overlay.add_script_file")),
                ),
        )
        .child(
            div()
                ...
                .child(
                    div()
                        ...
                        .gap(Spacing::SM)
                        .child(Icon::new(AppIcon::Folder).size(Heights::ICON_SM).muted())
                        .child(dory_i18n::t!("sidebar.overlay.add_script_folder")),
                ),
        )
        .child(
            div()
                ...
                .child(
                    div()
                        ...
                        .child(dory_i18n::t!("sidebar.overlay.import_file")),
                ),
        )
    }
    ...
    pub(super) fn open_child_picker_modal(
        ...
        let filter_input = cx.new(|cx| {
            InputState::new(window, cx)
                .placeholder(dory_i18n::t!("sidebar.filter.stream_placeholder"))
        });
                    ...
                    .when(visible_rows.is_empty(), |el| {
                        el.child(
                            div().px(Spacing::MD).py(Spacing::SM).child(
                                Text::muted(dory_i18n::t!("sidebar.overlay.child_picker.empty"))
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                Text::caption(dory_i18n::t!("sidebar.overlay.child_picker.prev"))
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                Text::caption(dory_i18n::t!("sidebar.overlay.child_picker.next"))
                                    .font_size(FontSizes::XS)
                                    .color(if can_next {
                                        theme.foreground
                                    } else {
