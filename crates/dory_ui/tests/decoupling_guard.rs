...
const SCOPE_DIRS: &[&str] = &[
    "crates/dory_ui/src",
    "crates/dory_ui_document/src",
    "crates/dory_ui_base/src",
    "crates/dory_ui_sidebar/src",
    "crates/dory_ui_windows/src",
    "crates/dory_components/src",
];

fn workspace_root() -> PathBuf {
    // CARGO_MANIFEST_DIR is the crates/dory_ui directory; go two levels up.
