...
actions!(
    ...
    [
        ...
        // dory_components::actions so dory_ui_document can reach them without an
        // upward dependency on dory_ui)
        SelectFirst,
        SelectLast,
        ExpandCollapse,
...
// Re-export shared document/navigation actions from dory_components so
// callers inside dory_ui can keep using `crate::keymap::SelectNext` etc.
pub use dory_components::actions::{
...
pub fn workspace_keybindings() -> Vec<KeyBinding> {
    vec![
        ...
        #[cfg(target_os = "macos")]
        KeyBinding::new("cmd-o", OpenScriptFile, None),
        #[cfg(target_os = "macos")]
        ...
        #[cfg(target_os = "macos")]
        KeyBinding::new("cmd-shift-a", OpenAuditViewer, None),
        #[cfg(not(target_os = "macos"))]
        KeyBinding::new("ctrl-,", OpenSettings, None),
        #[cfg(not(target_os = "macos"))]
        KeyBinding::new("ctrl-n", NewQueryTab, None),
        #[cfg(not(target_os = "macos"))]
        KeyBinding::new("ctrl-w", CloseCurrentTab, None),
        #[cfg(not(target_os = "macos"))]
        KeyBinding::new("ctrl-o", OpenScriptFile, None),
        #[cfg(not(target_os = "macos"))]
        KeyBinding::new("ctrl-s", SaveQuery, None),
        #[cfg(not(target_os = "macos"))]
        ...
        #[cfg(not(target_os = "macos"))]
        KeyBinding::new("ctrl-shift-a", OpenAuditViewer, None),
    ]
}
...
mod tests {
    ...
    fn input_context_keybindings_override_secondary_enter() {
        gpui::actions!(dory_test_only, [PriorEnterBinding]);
