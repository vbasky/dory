use super::*;
use dory_core::{DriverCapabilities, DriverMetadata};
...
fn collection_document_presentation_for_connection(
    ...
    let presentation = schema
        ...
        .unwrap_or(dory_core::CollectionPresentation::DataGrid);

    match presentation {
        dory_core::CollectionPresentation::DataGrid => CollectionDocumentPresentation::DataGrid,
        dory_core::CollectionPresentation::EventStream => CollectionDocumentPresentation::AuditLike,
        ...
        dory_core::CollectionPresentation::ObjectBrowser => {
...
mod tests {
    ...
    fn strip_annotation_header_removes_sql_annotations() {
        ...
        let result = Workspace::strip_annotation_header(content, &dory_core::QueryLanguage::Sql);
    ...
    fn strip_annotation_header_empty_content() {
        let result = Workspace::strip_annotation_header("", &dory_core::QueryLanguage::Sql);
        assert_eq!(result, "");
    }
    ...
    fn strip_annotation_header_mongo_comment_prefix() {
        let content = "// @connection: my-db\ndb.collection.find()";
        let result =
            Workspace::strip_annotation_header(content, &dory_core::QueryLanguage::MongoQuery);
    ...
    fn strip_annotation_header_redis_comment_prefix() {
        let content = "# @connection: my-db\nGET key";
        let result =
            Workspace::strip_annotation_header(content, &dory_core::QueryLanguage::RedisCommands);
