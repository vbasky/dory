...
use dory_driver_ipc::{IpcDriver, driver::IpcDriverLaunchConfig};
use dory_ipc::{
...
mod tests {
    ...
    use dory_core::{DatabaseCategory, DriverMetadataBuilder, QueryLanguage};
    ...
    fn discover_and_adapt_driver_service_preserves_rpc_registry_id() {
        ...
        match adaptation {
            DriverServiceAdaptation::Registered { driver_id, service } => {
                ...
                assert_eq!(service.2, "dory-driver-host");
            }
