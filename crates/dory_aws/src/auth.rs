...
use dory_core::{FormFieldDef, FormFieldKind, FormSection, FormTab, RefreshTrigger, SelectOption};
        ...
        profiles
            ...
            .filter_map(|p| {
                ...
                Some(AuthProfile {
                    ...
                    // live in ~/.aws/credentials, not in Dory storage.
...
impl dory_core::auth::DynAuthProvider for AwsSsoAuthProvider {
    ...
    fn register_value_providers(
        ...
        resolver: &mut dory_core::values::CompositeValueResolver,
    ) -> Result<(), DbError> {
    ...
    fn detect_importable_profiles(&self) -> Vec<ImportableProfile> {
        ...
        cache
            ...
            .map(|profile| {
                ...
                // flow can wire `sso_session_ref` to the matching Dory
...
#[async_trait::async_trait]
impl dory_core::auth::DynAuthProvider for AwsSharedCredentialsAuthProvider {
    fn provider_id(&self) -> &'static str {
...
#[async_trait::async_trait]
impl dory_core::auth::DynAuthProvider for AwsSsoSessionAuthProvider {
    fn provider_id(&self) -> &'static str {
        "aws-sso-session"
    }
...
mod tests {
    ...
    fn shared_credentials_always_valid() {
        ...
        let result = rt.block_on(async {
            dory_core::auth::DynAuthProvider::validate_session(&provider, &profile).await
        });
    ...
    fn aws_sso_capabilities_advertise_interactive_login() {
        ...
        assert!(
            <AwsSsoAuthProvider as dory_core::auth::DynAuthProvider>::capabilities(&provider)
                .login
                .supported
        );
        assert!(
    ...
    fn shared_credentials_provider_keeps_login_disabled() {
        ...
        let shared_capabilities =
            <AwsSharedCredentialsAuthProvider as dory_core::auth::DynAuthProvider>::capabilities(
                &shared,
            );
...
"#;
        ...
        let expected_id = dory_core::auth::aws_profile_uuid("aws-sso", "dev-sso");
        assert_eq!(
            p.id, expected_id,
...
"#;
        ...
        let expected_id = dory_core::auth::aws_profile_uuid("aws-sso-session", "my-org");
...
"#;
    ...
    fn shared_reflect_includes_credentials_file_profiles() {
        ...
        let expected_id = dory_core::auth::aws_profile_uuid("aws-shared-credentials", "ci-user");
...
"#;
    ...
    fn sso_save_edit_wrong_type_snapshot_returns_saved() {
        use dory_core::{AuthEditSnapshot, AuthSaveOutcome, DynAuthProvider};
