...
mod tests {
    ...
    impl QueryGenerator for RecordingGenerator {
        ...
        fn generate_mutation(
            &self,
            _mutation: &dory_core::MutationRequest,
    ...
    impl FakeConnection {
        fn new(
            ...
            let mut builder = dory_core::DriverMetadataBuilder::new(
                "fake",
                "Fake",
    ...
    impl Connection for FakeConnection {
        ...
        fn insert_row(&self, insert: &RowInsert) -> Result<dory_core::CrudResult, DbError> {
            ...
            Ok(dory_core::CrudResult::new(1, None))
        }
    }
    ...
    struct RealGeneratorConnection {
        executed_sql: Mutex<Vec<String>>,
        metadata: DriverMetadata,
        generator: dory_core::SqlMutationGenerator,
    }

    impl RealGeneratorConnection {
        fn new() -> Self {
            let metadata = dory_core::DriverMetadataBuilder::new(
                "fake",
                "Fake",
                dory_core::DatabaseCategory::Relational,
                QueryLanguage::Sql,
            ...
            Self {
                executed_sql: Mutex::new(Vec::new()),
                metadata,
                generator: dory_core::SqlMutationGenerator::new(&DIALECT),
            }
        }
    }
