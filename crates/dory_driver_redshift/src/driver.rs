...
///
/// Shape mirrors `dory_driver_postgres::POSTGRES_FORM` (same 12-field
...
mod tests {
    ...
    fn driver_key_and_kind_are_stable() {
        ...
        assert_eq!(driver.kind(), dory_core::DbKind::Redshift);
    }
    ...
    mod uri_helpers {
        ...
        fn strip_sslmode_removes_only_the_sslmode_parameter() {
            ...
            assert_eq!(
                strip_sslmode_query_param(
                    "postgresql://cluster.example.com:5439/dev?application_name=dory"
                ),
                "postgresql://cluster.example.com:5439/dev?application_name=dory"
            );
        }
