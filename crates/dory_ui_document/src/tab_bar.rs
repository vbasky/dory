...
use dory_components::composites::MenuItem;
...
use dory_components::typography::MonoMeta;
...
impl TabBar {
    ...
    pub fn build_tab_menu_items() -> Vec<MenuItem> {
        vec![
            MenuItem::new(dory_i18n::t!("document.tabs.menu.close")).icon(AppIcon::X),
            MenuItem::new(dory_i18n::t!("document.tabs.menu.close_others")).icon(AppIcon::X),
            MenuItem::new(dory_i18n::t!("document.tabs.menu.close_all")).icon(AppIcon::X),
            MenuItem::separator(),
            MenuItem::new(dory_i18n::t!("document.tabs.menu.close_left"))
                .icon(AppIcon::ChevronLeft),
            MenuItem::new(dory_i18n::t!("document.tabs.menu.close_right"))
        ...
        div()
            ...
            .when(is_dirty, |el| {
                ...
                let tooltip_text: SharedString = change_summary
                    .unwrap_or_else(|| dory_i18n::t!("document.tabs.unsaved_changes"))
                    .into();
...
mod tests {
    ...
    fn build_tab_menu_items_returns_correct_structure() {
        ...
        assert_eq!(
            ...
            dory_i18n::t!("document.tabs.menu.close", locale = "en")
        );
        assert_eq!(
            items[TAB_MENU_CLOSE_OTHERS].label.as_ref(),
            dory_i18n::t!("document.tabs.menu.close_others", locale = "en")
        );
        assert_eq!(
            items[TAB_MENU_CLOSE_ALL].label.as_ref(),
            dory_i18n::t!("document.tabs.menu.close_all", locale = "en")
        );
        assert!(items[TAB_MENU_SEPARATOR].is_separator);
        assert_eq!(
            items[TAB_MENU_CLOSE_LEFT].label.as_ref(),
            dory_i18n::t!("document.tabs.menu.close_left", locale = "en")
        );
        assert_eq!(
            items[TAB_MENU_CLOSE_RIGHT].label.as_ref(),
            dory_i18n::t!("document.tabs.menu.close_right", locale = "en")
        );
    }
