...
use dory_components::primitives::{Icon, Text, overlay_bg, surface_modal_container};
...
/// `dory_ui_document` in Step 3b without dragging the full app-state seam.
