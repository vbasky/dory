...
impl ExportPhase {
    ...
    pub fn label(self) -> String {
        match self {
            ExportPhase::Tables => dory_i18n::t!("document.export_wizard.rail.tables"),
            ExportPhase::FormatOptions => {
                dory_i18n::t!("document.export_wizard.rail.format_options")
            }
            ExportPhase::Confirm => dory_i18n::t!("document.export_wizard.rail.confirm"),
            ExportPhase::Run => dory_i18n::t!("document.export_wizard.rail.run"),
        }
    }
}
...
mod tests {
    ...
    fn phase_labels_cover_every_rail_entry() {
        assert_eq!(
            ...
            dory_i18n::t!("document.export_wizard.rail.tables")
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            dory_i18n::t!("document.export_wizard.rail.confirm")
        );
        assert_eq!(
            ExportPhase::Run.label(),
            dory_i18n::t!("document.export_wizard.rail.run")
        );
    }
