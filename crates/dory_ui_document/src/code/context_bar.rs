...
use dory_components::composites::control_shell;
use dory_components::primitives::{Icon, Text, focus_frame};
...
fn parse_source_datetime_input(value: &str) -> Option<i64> {
    ...
    dory_core::chrono::DateTime::parse_from_rfc3339(trimmed)
        .ok()
...
impl CodeDocument {
    ...
    pub(super) fn current_source_context_spec(
        &self,
        cx: &App,
    ) -> Option<dory_core::SourceContextSpec> {
    ...
    fn sync_source_controls(&mut self, cx: &mut Context<Self>) {
        ...
        let targets_placeholder = source_spec
            ...
            .unwrap_or_else(|| dory_i18n::t!("document.code.context_bar.fallback.sources"));
                ...
                Err(e) => {
                    ...
                    cx.update(|cx| {
                        this.update(cx, |doc, cx| {
                            ...
                            doc.pending.error = Some(dory_i18n::t!(
        ...
        let main_row = div()
            ...
            .when(show_source_controls, |el| {
                ...
                let el = el
                    ...
                    .child(div().flex_none().child(Text::caption(dory_i18n::t!(
                    ...
                    el.when_some(
                        (!is_chart_mode)
                            ...
                            .map(|p| {
                                ...
                                let label =
                                    source_spec.map(|s| s.start_label.clone()).unwrap_or_else(
                                        || dory_i18n::t!("document.code.context_bar.fallback.time"),
                                    );
                                (dropdown, label)
                            }),
                        |el, (dropdown, label)| {
                        ...
                        el.child(
                            div().flex_none().child(Text::caption(
                                source_spec
                                    ...
                                    .unwrap_or_else(|| {
                                        dory_i18n::t!("document.code.context_bar.fallback.start")
                                    }),
                            )),
                        )
                        ...
                        .child(
                            div().flex_none().child(Text::caption(
                                source_spec
                                    ...
                                    .unwrap_or_else(|| {
                                        dory_i18n::t!("document.code.context_bar.fallback.end")
                                    }),
                            )),
                        )
                        .child(div().flex_none().min_w(px(180.0)).child(focus_frame(
            ...
            .when(!show_source_controls && show_db, |el| {
                el.child(div().flex_none().child(Text::caption(dory_i18n::t!(
                    ...
                    div()
                        ...
                        .child(
                            Button::new(
                                ...
                                dory_i18n::t!("document.code.context_bar.apply"),
                            )
                            .small()
                            .disabled(!can_apply)
