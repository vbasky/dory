...
///
/// Modeled directly on `dory_components::result_panel::ToolbarSegment` —
...
pub struct CodeSessionTabSnapshot {
    ...
    pub title: String,
    pub language: dory_core::QueryLanguage,
...
pub struct PaneHandle {
    ...
    pub matches_event_stream:
        Option<Box<dyn Fn(uuid::Uuid, &dory_core::EventStreamTarget, &App) -> bool>>,
