...
pub(crate) fn build_statements_for_change(
    ...
    match change {
        ...
        SchemaChange::IndexAdded(index) => code_generator
            .generate_create_index(&dory_core::CreateIndexRequest {
        ...
        SchemaChange::IndexRemoved(index) => code_generator
            .generate_drop_index(&dory_core::DropIndexRequest {
                index_name: &index.name,
        ...
        match self.deps.policy {
            ...
            MutationPolicy::ReadOnly => {
                return Ok(DdlApplyOutcome::Blocked {
                    reason: dory_i18n::t!("document.schema_diff.apply.read_only"),
                });
            }
...
mod tests {
    ...
    mod statement_mapping_tests {
        ...
        impl CodeGenerator for StubCodeGenerator {
            fn capabilities(&self) -> dory_core::CodeGenCapabilities {
                dory_core::CodeGenCapabilities::ADD_COLUMN
                    | dory_core::CodeGenCapabilities::DROP_COLUMN
                    | dory_core::CodeGenCapabilities::ALTER_COLUMN
                    | dory_core::CodeGenCapabilities::CREATE_INDEX
                    | dory_core::CodeGenCapabilities::DROP_INDEX
            }

            fn generate_create_index(
                &self,
                request: &dory_core::CreateIndexRequest,
            ) -> Option<String> {
            ...
            fn generate_drop_index(&self, request: &dory_core::DropIndexRequest) -> Option<String> {
        ...
        fn index_generator_returning_none_surfaces_as_rejection() {
            ...
            impl CodeGenerator for NoneCodeGenerator {
                fn capabilities(&self) -> dory_core::CodeGenCapabilities {
                    dory_core::CodeGenCapabilities::empty()
                }
            }
