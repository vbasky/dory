                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(Input::new(&input).placeholder(dory_i18n::t!(
                                ...
                                div()
                                    ...
                                    .child(
                                        Button::new("cancel-save")
                                            .label(dory_i18n::t!("document.chart.shell.cancel"))
                                            .small()
                ...
                Some(ChartDetection::EmptyResult) | None => {
                    if is_metric {
                        if self.exec_state == ExecState::Running {
                            dory_i18n::t!("document.chart.shell.degraded.loading_metric")
                        } else {
                            dory_i18n::t!("document.chart.shell.degraded.no_data_points")
                        }
                    } else {
                        dory_i18n::t!("document.chart.shell.degraded.run_query")
                    }
                }
                Some(ChartDetection::NoTimeColumn) => {
                    dory_i18n::t!("document.chart.shell.degraded.no_time_column")
                }
                Some(ChartDetection::NoNumericSeries) => {
                    dory_i18n::t!("document.chart.shell.degraded.no_numeric_series")
                }
                Some(ChartDetection::Ok { .. }) => {
                    dory_i18n::t!("document.chart.shell.degraded.build_failed")
                }
            };
            div()
                .size_full()
    ...
    fn render_stats_rail(
        ...
        let Some(chart_view) = chart_view_opt else {
            return Some(self.wrap_stats_rail_chrome(
                placeholder(dory_i18n::t!("document.chart.shell.stats_rail.rebuilding")),
                theme,
                &chart_colors,
            ));
        };
        ...
        let Some(stats) = stats_opt else {
            return Some(self.wrap_stats_rail_chrome(
                placeholder(dory_i18n::t!("document.chart.shell.stats_rail.no_stats")),
                theme,
                &chart_colors,
            ));
        };
        ...
        let unavail_val = || -> AnyElement {
            div()
                ...
                .text_color(theme.muted_foreground)
                .italic()
                .child(dory_i18n::t!("document.chart.shell.stats_rail.unavailable"))
                .into_any_element()
        };
        ...
        let body = div()
            ...
            .child(dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(dock_header(
                        &dory_i18n::t!("document.chart.toolbar.stats"),
                        &chart_colors,
                    ))
            ...
            .child(dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(dock_header(
                        &dory_i18n::t!("document.chart.shell.stats_rail.window_title"),
                        &chart_colors,
                    ))
                    .child(dock_kv_row(
                        &dory_i18n::t!("document.chart.shell.stats_rail.window.start"),
                        str_val(start_label),
                        &chart_colors,
                    ))
                    .child(dock_kv_row(
                        &dory_i18n::t!("document.chart.shell.stats_rail.window.end"),
                        str_val(end_label),
                        &chart_colors,
                    ))
                    .child(dock_kv_row(
                        &dory_i18n::t!("document.chart.shell.stats_rail.window.span"),
                        str_val(span_label),
                        &chart_colors,
                    ))
                    .child(dock_kv_row(
                        &dory_i18n::t!("document.chart.shell.stats_rail.window.points"),
            ...
            .child(dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(dock_header(
                        &dory_i18n::t!("document.chart.shell.stats_rail.source_title"),
                        &chart_colors,
                    ))
        ...
        let header = div()
            ...
            .child(
                div()
                    ...
                    .text_color(muted_fg)
                    .font_weight(FontWeight::BOLD)
                    .child(dory_i18n::t!("document.chart.toolbar.stats").to_uppercase()),
            )
            .child(
                div()
