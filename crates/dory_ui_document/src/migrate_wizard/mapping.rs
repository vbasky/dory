...
use dory_core::{TableRef, TransferColumn};
...
impl MappingPhase {
    ...
    fn open_drilldown(&mut self, row_index: usize, cx: &mut Context<Self>) {
        ...
        for (target_index, binding) in row.config.bindings.iter().enumerate() {
            let mut items = vec![DropdownItem::new(dory_i18n::t!(
        ...
        let transform_cell = div()
            ...
            .child(
                Button::new(
                    ...
                    dory_i18n::t!("document.migrate_wizard.mapping.columns_button"),
                )
                .small()
                .ghost()
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .gap(Spacing::SM)
                    .child(div().w(TARGET_COL_W).child(Text::label(dory_i18n::t!(
...
fn render_grid_header(cx: &mut Context<MappingPhase>) -> impl IntoElement {
    ...
    div()
        ...
        .child(div().w(MODE_COL_W).child(Text::label(dory_i18n::t!(
            "document.migrate_wizard.mapping.header_mapping_mode"
        ))))
        .child(div().w(TRANSFORM_COL_W).child(Text::label(dory_i18n::t!(
