...
impl DataGridPanel {
    ...
    pub(super) fn render_filter_submenu_section(
        ...
        *visual_index += 1;
        ...
        let filter_title = dory_i18n::t!("document.data.context_menu.filter.title");
        let cell_value_label = dory_i18n::t!("document.data.context_menu.filter.cell_value");
    ...
    pub(super) fn render_order_submenu_section(
        ...
        let order_title = dory_i18n::t!("document.data.context_menu.order.title");
        let remove_ordering_label = dory_i18n::t!("document.data.context_menu.order.remove");
    ...
    fn build_order_submenu_flyout(
        ...
        let order_items: Vec<(String, ContextMenuAction, AppIcon)> = vec![
            (
                ...
                ContextMenuAction::Order(dory_core::SortDirection::Ascending),
                AppIcon::ArrowUp,
            ),
            (
                format!("{} DESC", col_name_for_order),
                ContextMenuAction::Order(dory_core::SortDirection::Descending),
                AppIcon::ArrowDown,
            ),
            (
                remove_ordering_label,
    ...
    pub(super) fn render_generate_sql_submenu_section(
        ...
        *visual_index += 1; // Separator takes an index slot
        ...
        let generate_sql_title = dory_i18n::t!("document.data.context_menu.generate_sql.title");
        ...
        deferred(
            div()
                ...
                .on_key_down(cx.listener(|this, event: &KeyDownEvent, window, cx| {
                    use dory_app::keymap::KeyChord;
                    use dory_ui_base::keymap::{default_keymap, key_chord_from_gpui};
...
mod tests {
    ...
    fn context_menu_filter_title_differs_between_locales() {
        let en = dory_i18n::t!("document.data.context_menu.filter.title", locale = "en");
        let es = dory_i18n::t!("document.data.context_menu.filter.title", locale = "es");
