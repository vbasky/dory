...
pub fn count_assignment_params(assignments: &[dory_core::Assignment]) -> u32 {
...
impl MutationExecutor {
    ...
    pub fn run_single_tx(
        ...
        let op_kind = match &self.spec.kind {
            dory_core::MutationKind::Update { .. } => "update",
            dory_core::MutationKind::Delete => "delete",
        };
    ...
    pub fn run_chunked_tx(
        ...
        use dory_core::lower_keyset_predicate;
    ...
    fn reset_lock_timeout_if_needed(&self, vocab: &TransactionVocab) {
        ...
        {
            let reset_req = dory_core::QueryRequest::new(reset_sql);
...
mod tests {
    ...
    mod executor_tests {
        ...
        impl dory_core::Connection for RecordingConnection {
            ...
            fn schema(&self) -> Result<SchemaSnapshot, dory_core::DbError> {
        ...
        impl QueryGenerator for SimpleDeleteGenerator {
            ...
            fn generate_delete_from_spec(
                &self,
                spec: &VisualMutationSpec,
            ) -> Result<GeneratedMutation, dory_core::GeneratorError> {
            ...
            fn generate_update_from_spec(
                ...
                Ok(GeneratedMutation {
                    ...
                    params: vec![dory_core::Value::Int(1)],
                    used_raw_expression: false,
                })
            }
        }
        ...
        fn make_deps(
            ...
            MutationDeps {
                connection: conn as Arc<dyn dory_core::Connection>,
                event_sink,
        ...
        fn g1_parent_event_emitted_with_pending_at_start() {
            ...
            let pending = events.iter().find(|e| {
                e.outcome == dory_core::EventOutcome::Pending && e.action == "mutation.run"
            });
            assert!(
                pending.is_some(),
        ...
        fn g2_parent_event_finalized_with_success() {
            ...
            let success_event = events.iter().find(|e| {
                e.outcome == dory_core::EventOutcome::Success && e.action == "mutation.run"
            });
            assert!(
        ...
        fn mysql_lock_timeout_reset_emitted_after_rollback() {
            ...
            impl dory_core::Connection for FailingDMLOnMySQL {
                fn metadata(&self) -> &dory_core::DriverMetadata {
                    &self.meta
                }
                fn ping(&self) -> Result<(), dory_core::DbError> {
                ...
                fn execute(
                    ...
                    if sql_upper.starts_with("DELETE") || sql_upper.starts_with("UPDATE") {
                        return Err(dory_core::DbError::query_failed("simulated DML error"));
                    }
                    Ok(QueryResult::empty())
                }
                fn cancel(&self, _: &dory_core::QueryHandle) -> Result<(), dory_core::DbError> {
                    Ok(())
                }
                fn schema(&self) -> Result<SchemaSnapshot, dory_core::DbError> {
                    Err(dory_core::DbError::NotSupported("stub".to_string()))
        ...
        fn single_tx_cancel_between_begin_and_dml_rolls_back() {
            ...
            impl dory_core::Connection for CancelOnBeginConnection {
                fn metadata(&self) -> &dory_core::DriverMetadata {
                    &self.meta
                }
                fn ping(&self) -> Result<(), dory_core::DbError> {
                ...
                fn cancel(
                    &self,
                    _handle: &dory_core::QueryHandle,
                ) -> Result<(), dory_core::DbError> {
                    Ok(())
                }
                fn schema(&self) -> Result<SchemaSnapshot, dory_core::DbError> {
                    Err(dory_core::DbError::NotSupported("stub".to_string()))
        ...
        fn single_tx_cancel_after_lock_timeout_set_returns_cancelled_without_begin() {
            ...
            impl dory_core::Connection for CancelOnSetConnection {
                fn metadata(&self) -> &dory_core::DriverMetadata {
                    &self.meta
                }
                fn ping(&self) -> Result<(), dory_core::DbError> {
        ...
        fn single_tx_cancel_after_dml_rolls_back() {
            ...
            impl dory_core::Connection for CancelOnDmlConnection {
                fn metadata(&self) -> &dory_core::DriverMetadata {
                    &self.meta
                }
                fn ping(&self) -> Result<(), dory_core::DbError> {
    ...
    mod chunked_executor_tests {
        ...
        impl ProgrammedConnection {
            ...
            fn new_with_max_params(
                ...
                use dory_core::QueryCapabilities;
        ...
        impl dory_core::Connection for ProgrammedConnection {
            fn metadata(&self) -> &dory_core::DriverMetadata {
                &self.meta
            }
        ...
        fn f4_chunk_dml_failure_triggers_rollback_and_halts() {
            ...
            impl dory_core::Connection for FailingDMLConn {
                fn metadata(&self) -> &dory_core::DriverMetadata {
                    &self.meta
                }
                fn ping(&self) -> Result<(), dory_core::DbError> {
        ...
        fn chunked_chunk_size_accounts_for_filter_and_set_params() {
            ...
            let spec = VisualMutationSpec {
                ...
                filter,
                kind: dory_core::MutationKind::Update { assignments },
            };
    ...
    mod count_tests {
        ...
        static FAKE_META: std::sync::OnceLock<dory_core::DriverMetadata> =
            std::sync::OnceLock::new();

        fn fake_meta() -> &'static dory_core::DriverMetadata {
        ...
        impl dory_core::Connection for CountReturningConnection {
            fn metadata(&self) -> &dory_core::DriverMetadata {
                fake_meta()
            }
            ...
            fn execute(
                ...
                match &self.result {
                    ...
                    Err(msg) => Err(dory_core::DbError::query_failed(msg.clone())),
                }
            }

            fn cancel(&self, _handle: &QueryHandle) -> Result<(), dory_core::DbError> {
                Ok(())
            }
    ...
    mod k_tests {
        ...
        impl dory_core::Connection for FailingConnection {
            fn metadata(&self) -> &dory_core::DriverMetadata {
                &self.meta
            }
            ...
            fn execute(
                ...
                if sql.starts_with("DELETE") || sql.starts_with("UPDATE") {
                    Err(dory_core::DbError::QueryFailed(
                        dory_core::FormattedError::new("simulated driver error"),
                    ))
                } else {
                    Ok(dory_core::QueryResult::empty())
                }
            }
    ...
    mod fix_tests {
        ...
        fn mysql_lock_timeout_emitted_before_begin() {
            ...
            impl dory_core::Connection for MysqlRecordingConn {
                fn metadata(&self) -> &dory_core::DriverMetadata {
                    &self.meta
                }
                fn ping(&self) -> Result<(), dory_core::DbError> {
        ...
        fn chunked_run_events_have_monotonic_timestamps() {
            use dory_core::{EventRecord, EventSink, EventSinkError, MutationPolicy};
            use std::sync::{Arc, Mutex};
            ...
            let deps = MutationDeps {
                connection: conn as Arc<dyn dory_core::Connection>,
                event_sink: Some(sink as Arc<dyn dory_core::EventSink>),
                policy: MutationPolicy::Allowed,
            };
            let executor = MutationExecutor::new(spec, opts, deps);
            let _outcome = executor.run_single_tx(&no_cancel());
