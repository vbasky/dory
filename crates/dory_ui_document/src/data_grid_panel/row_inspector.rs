...
use dory_components::primitives::{Icon, LoadingState, Text};
    ...
    div()
        ...
        .child(
            Text::caption(label.into())
                .font_size(dory_components::tokens::FontSizes::XS)
...
fn render_references_section(
    ...
    let resolving_label = dory_i18n::t!("document.data.row_inspector.references.resolving");
    let not_found_label = dory_i18n::t!("document.data.row_inspector.references.not_found");
    ...
    div()
        ...
        .child(
            div()
                ...
                .text_size(dory_components::tokens::FontSizes::XS)
...
fn render_column_metadata(
    ...
    let yes_label = dory_i18n::t!("document.data.row_inspector.meta.yes");
    let no_label = dory_i18n::t!("document.data.row_inspector.meta.no");
    ...
    div()
        ...
        .child(render_meta_row(
            &dory_i18n::t!("document.data.row_inspector.meta.name"),
            &cell.name,
            theme,
        ))
        .child(render_meta_row(
            &dory_i18n::t!("document.data.row_inspector.meta.type"),
            &cell.type_label,
            theme,
        ))
        .child(render_meta_row(
            &dory_i18n::t!("document.data.row_inspector.meta.nullable"),
            bool_label(cell.nullable),
            theme,
        ))
        .child(render_meta_row(
            &dory_i18n::t!("document.data.row_inspector.meta.primary_key"),
            bool_label(cell.is_primary_key),
            theme,
        ))
        .child(render_meta_row(
            &dory_i18n::t!("document.data.row_inspector.meta.foreign_key"),
...
impl Render for RowInspectorContent {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let pk_badge = dory_i18n::t!("document.data.row_inspector.badge.primary_key");
        let fk_badge = dory_i18n::t!("document.data.row_inspector.badge.foreign_key");
        ...
        div()
            ...
            .child(render_section_header(
                dory_i18n::t!("document.data.row_inspector.section.row"),
                theme,
            ))
            .children(
                snapshot
            ...
            .when(has_fk, |d| {
                d.child(render_section_header(
                    dory_i18n::t!("document.data.row_inspector.section.references"),
                    theme,
                ))
            ...
            .child(render_section_header(
                dory_i18n::t!("document.data.row_inspector.section.column"),
                theme,
            ))
            .when_some(
                snapshot.cells.get(
...
mod tests {
    ...
    fn row_inspector_title_differs_between_locales() {
        let en = dory_i18n::t!("document.data.row_inspector.section.row", locale = "en");
        let es = dory_i18n::t!("document.data.row_inspector.section.row", locale = "es");
    ...
    fn row_inspector_meta_yes_no_labels_differ_between_locales() {
        let en_yes = dory_i18n::t!("document.data.row_inspector.meta.yes", locale = "en");
        let es_yes = dory_i18n::t!("document.data.row_inspector.meta.yes", locale = "es");
