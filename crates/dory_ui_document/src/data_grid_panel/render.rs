...
use dory_components::chart::legend::legend_element;
...
use dory_components::chart::{SourceRowRef, point_inspector_element};
...
use dory_components::controls::{Checkbox, Input, InputState, completion_input_keys_wrapper};
use dory_components::icons::AppIcon;
use dory_components::primitives::{BannerBlock, BannerVariant, Icon, Text, surface_raised};
use dory_components::semantic::ChartColors;
use dory_components::tokens::{FontSizes, Heights, Radii, Spacing};
use dory_core::{ColumnKind, Pagination, QueryResultShape, SortDirection, Value};
...
impl DataGridPanel {
    ...
    pub(super) fn process_pending_actions(&mut self, window: &mut Window, cx: &mut Context<Self>) {
        ...
        dory_ui_base::toast::flush_pending_toast(self.pending.toast.take(), window, cx);
            ...
            .when(st.show_grouped_warning, |d| {
                d.child(
                    div()
                        ...
                        .child(
                            Text::caption(dory_i18n::t!("document.data.grid.editing.aggregated"))
                                .color(st.theme.muted_foreground),
                        ),
                )
            })
                        ...
                        d.flex()
                            ...
                            .child(if is_loading {
                                div()
                                    ...
                                    .child(Text::muted(dory_i18n::t!("document.data.grid.loading")))
                                    .into_any_element()
                            } else {
                                Text::muted(dory_i18n::t!("document.data.grid.empty"))
                                    .into_any_element()
                            })
                    },
                );
...
pub(super) fn render_filter_bar_as_segment(
    ...
    let refresh_label = if refresh_policy.is_auto() {
        ...
        dory_i18n::t!("document.data.grid.toolbar.refresh")
    };
...
impl DataGridPanel {
        ...
        compact_top_bar(theme, std::iter::empty::<AnyElement>())
            ...
            .when(self.can_toggle_view(), |d| {
                ...
                let _tooltip = match mode {
                    DataViewMode::Table => {
                        dory_i18n::t!("document.data.grid.toolbar.switch_to_document")
                    }
                    DataViewMode::Document => {
                        dory_i18n::t!("document.data.grid.toolbar.switch_to_table")
                    }
                };
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                Text::caption(dory_i18n::t!("document.data.grid.edit_bar.save"))
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                Text::caption(dory_i18n::t!("document.data.grid.edit_bar.revert"))
                                    .color(if has_changes {
                                        theme.foreground
                                    } else {
                                        theme.muted_foreground
    ...
    pub(super) fn render_chart_toolbar(
            ...
            on_png_export: Arc::new(move |_window, cx| {
                if let Some(panel) = weak_panel.upgrade() {
                    panel.update(cx, |this, _cx| {
                        this.pending.toast = Some(dory_ui_base::toast::PendingToast {
                            message: dory_i18n::t!(
                                "document.data.grid.export.png_coming_soon",
                                detail = dory_ui_base::toast::now_hms()
                            ),
                            is_error: false,
                        });
                    });
                ...
                let row = div()
                    ...
                    .child(
                        Button::new(
                            ...
                            dory_i18n::t!("document.data.chart_dock.toolbar.apply"),
                        )
                        .small()
                        .disabled(!can_apply)
        ...
        let axis_row = dory_components::chart::axis_bar_element(
            &bindings,
            &columns,
            open_pill,
            &chart_colors,
    ...
    fn render_point_inspector(
        ...
        let (hovered_x, hovered_y) = self
            ...
            .and_then(|s| {
                ...
                let x_str = dory_components::chart::format_x_value(x, x_is_time);
                ...
                let y_str = chart
                    ...
                    .and_then(|pi| {
                        ...
                        Some(dory_components::chart::format_y_value(pts.get(pi)?.1))
                    })
                    .unwrap_or_default();
                Some((x_str, y_str))
            })
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(Input::new(&name_input).placeholder(dory_i18n::t!(
                        ...
                        div()
                            ...
                            .child(
                                Button::new("cancel-collection-chart-save")
                                    .label(dory_i18n::t!("document.data.chart_dock.save.cancel"))
                                    .small()
                            ...
                            .child(
                                Button::new("confirm-collection-chart-save")
                                    .label(dory_i18n::t!("document.data.chart_dock.save.save"))
                                    .small()
                ...
                div()
                    ...
                    .when(can_pick, |d| {
                        let label = if picker_open {
                            dory_i18n::t!("document.data.chart_dock.degraded.hide_picker")
                        } else {
                            dory_i18n::t!("document.data.chart_dock.degraded.pick_time_column")
                        };
    ...
    fn render_chart_picker_overlay(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let apply_btn = div()
            ...
            .child(dory_i18n::t!("document.data.chart_dock.picker.apply"));
        ...
        div()
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.configure.why.title"),
                        &chart_colors,
                    ))
                    .child(
                        div()
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .gap(Spacing::XS)
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.configure.time_column.title"),
                        &chart_colors,
                    ))
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .gap(Spacing::XXS)
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.configure.series.title"),
                        &chart_colors,
                    ))
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.configure.axis_stacking.title"),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.configure.axis_stacking.y_axis"),
                    ...
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.configure.axis_stacking.stack"),
                        div()
                            .text_size(px(11.0))
                            .text_color(theme.muted_foreground)
                            .child(dory_i18n::t!(
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(dory_i18n::t!("document.data.chart_dock.configure.reset")),
                    )
                    // Apply button
                    .child(
                        div()
                            ...
                            .child(dory_i18n::t!("document.data.chart_dock.toolbar.apply")),
                    ),
            )
    }
    ...
    fn render_rail_stats_tab(
        ...
        let (stats_opt, label, color, x_min, x_max, x_is_time) = if let Some(cv) = &chart_view_opt {
            ...
            return div()
                ...
                .text_size(FontSizes::XS)
                .text_color(theme.muted_foreground)
                .child(dory_i18n::t!("document.data.chart_dock.stats.rebuilding"))
                .into_any_element();
        };
        ...
        let Some(stats) = stats_opt else {
            return div()
                ...
                .text_size(FontSizes::XS)
                .text_color(theme.muted_foreground)
                .child(dory_i18n::t!("document.data.chart_dock.stats.no_stats"))
                .into_any_element();
        };
        ...
        let unavail_val = || -> gpui::AnyElement {
            div()
                ...
                .text_color(theme.muted_foreground)
                .italic()
                .child(dory_i18n::t!("document.data.chart_dock.stats.unavailable"))
                .into_any_element()
        };
        ...
        div()
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.stats.title"),
                        &chart_colors,
                    ))
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.stats.window.title"),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.window.start"),
                        str_val(start_label),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.window.end"),
                        str_val(end_label),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.window.span"),
                        str_val(span_label),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.window.points"),
            ...
            .child(Self::dock_section(
                div()
                    ...
                    .gap(px(2.0))
                    .child(Self::dock_header(
                        &dory_i18n::t!("document.data.chart_dock.stats.source.title"),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.source.measurement"),
                        unavail_val(),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.source.field"),
                        unavail_val(),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.source.host"),
                        unavail_val(),
                        &chart_colors,
                    ))
                    .child(Self::dock_kv_row(
                        &dory_i18n::t!("document.data.chart_dock.stats.source.region"),
                        unavail_val(),
                        &chart_colors,
                    )),
                theme,
    ...
    fn render_raw_view(
        ...
        let hex_dump = if let Some(bytes) = raw_bytes {
            ...
            dory_i18n::t!("document.data.grid.views.empty")
        };
                ...
                div()
                    ...
                    .when_some(result_shape_label, |d, shape| {
                        let label = match &shape {
                            dory_core::QueryResultShape::Table => "table",
                            dory_core::QueryResultShape::Json => "json",
                            dory_core::QueryResultShape::Text => "text",
                            dory_core::QueryResultShape::Binary => "binary",
                        };
    ...
    fn render_export_button(
        ...
        let formats = dory_export::available_formats(&self.result.shape);
        ...
        div()
            ...
            .child(
                Text::caption(dory_i18n::t!("document.data.grid.export.trigger"))
                    .muted_foreground(),
            )
            .child(
    ...
    fn render_export_menu(
        &self,
        formats: &[dory_export::ExportFormat],
        theme: &gpui_component::theme::Theme,
        cx: &mut Context<Self>,
    ) -> impl IntoElement {
        ...
        items.push(section_header(
            dory_i18n::t!("document.data.grid.export.save_as_file").into(),
        ));
        ...
        items.push(section_header(
            dory_i18n::t!("document.data.grid.export.copy_to_clipboard").into(),
        ));

        for (idx, &format) in formats.iter().enumerate() {
            let copyable = !matches!(format, dory_export::ExportFormat::Binary);
            let row = div()
...
mod tests {
    ...
    fn data_grid_toolbar_refresh_differs_between_locales() {
        let english = dory_i18n::t!("document.data.grid.toolbar.refresh", locale = "en");
        let spanish = dory_i18n::t!("document.data.grid.toolbar.refresh", locale = "es");
    ...
    fn data_grid_export_menu_differs_between_locales() {
        let save_en = dory_i18n::t!("document.data.grid.export.save_as_file", locale = "en");
        let save_es = dory_i18n::t!("document.data.grid.export.save_as_file", locale = "es");
        let copy_en = dory_i18n::t!("document.data.grid.export.copy_to_clipboard", locale = "en");
        let copy_es = dory_i18n::t!("document.data.grid.export.copy_to_clipboard", locale = "es");
