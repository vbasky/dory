...
use dory_core::{KeyGetResult, KeyType, Value, ValueRepr};
use gpui::Hsla;
...
pub(super) fn key_type_label(key_type: KeyType) -> String {
    match key_type {
        KeyType::String => dory_i18n::t!("document.key_value.parsing.type.string"),
        KeyType::Bytes => dory_i18n::t!("document.key_value.parsing.type.bytes"),
        KeyType::Hash => dory_i18n::t!("document.key_value.parsing.type.hash"),
        KeyType::List => dory_i18n::t!("document.key_value.parsing.type.list"),
        KeyType::Set => dory_i18n::t!("document.key_value.parsing.type.set"),
        KeyType::SortedSet => dory_i18n::t!("document.key_value.parsing.type.sorted_set"),
        KeyType::Json => dory_i18n::t!("document.key_value.parsing.type.json"),
        KeyType::Stream => dory_i18n::t!("document.key_value.parsing.type.stream"),
        KeyType::Unknown => dory_i18n::t!("document.key_value.parsing.type.unknown"),
    }
}
...
mod tests {
    ...
    use dory_components::icons::AppIcon;
    use dory_core::{KeyEntry, KeyGetResult, KeyType, Value, ValueRepr};
