...
use dory_core::QueryResultShape;
...
impl DataViewMode {
    ...
    pub fn label(&self) -> String {
        match self {
            DataViewMode::Table => dory_i18n::t!("document.data.grid.mode.table"),
            DataViewMode::Document => dory_i18n::t!("document.data.grid.mode.document"),
        }
    }
}
...
mod tests {
    ...
    use crate::data_grid_panel::DataSource;
    use dory_core::{CollectionRef, Pagination, QueryResult, TableRef};
    use std::sync::Arc;
    use uuid::Uuid;
