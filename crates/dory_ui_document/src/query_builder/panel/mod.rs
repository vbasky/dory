...
fn build_mutation_count_sql(spec: &CountSpec, dialect: &dyn dory_core::SqlDialect) -> String {
...
pub struct QueryBuilderPanel {
    ...
    generate_mutation_preview: Box<dyn Fn(&dory_core::VisualMutationSpec) -> String + Send + Sync>,
    ...
    pub(crate) column_kinds: std::collections::HashMap<String, dory_core::ColumnKind>,
