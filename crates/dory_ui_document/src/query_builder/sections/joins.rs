...
pub fn render_joins(
    ...
    if fk_loading && !join_rows.is_empty() {
        container = container.child(div().text_sm().child(SharedString::from(dory_i18n::t!(
                ...
                header.child(
                    completion_input_keys_wrapper(to_table_state)
                        ...
                        .child(Input::new(to_table_state).small().w_full().placeholder(
                            dory_i18n::t!("document.query_builder.joins.table_placeholder"),
                        )),
                );
        } else {
            header = header.child(
    ...
    container = container.child(
        Button::new(
            "qb-add-join",
            dory_i18n::t!("document.query_builder.joins.add_join"),
        )
        .ghost()
        .small()
        .on_click(cx.listener(move |this, _event, _window, cx| {
            ...
            let mut header = div()
                ...
                .child(
                    Button::new(
                        ...
                        dory_i18n::t!("document.query_builder.joins.add_condition"),
                    )
                    .ghost()
                    .small()
                    .on_click(cx.listener(move |this, _event, _window, cx| {
