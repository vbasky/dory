    ...
    pub fn new(window: &mut Window, cx: &mut Context<Self>) -> Self {
        let name_input = cx.new(|cx| {
            InputState::new(window, cx)
                .placeholder(dory_i18n::t!("modals.create_dashboard.name_label"))
        });
...
impl Render for ModalCreateDashboard {
    fn render(&mut self, _window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let body = div()
            ...
            .gap(Spacing::SM)
            .child(
                Text::label(dory_i18n::t!("modals.create_dashboard.name_label")).into_any_element(),
            )
        ...
        let footer = div()
            ...
            .child(
                Button::new(
                    ...
                    dory_i18n::t!("modals.create_dashboard.cancel"),
                )
                .on_click(on_cancel),
            )
            .child(
                Button::new(
                    ...
                    dory_i18n::t!("modals.create_dashboard.confirm"),
                )
                .primary()
                .on_click(on_confirm),
            );
        ...
        ModalShell::new(
            dory_i18n::t!("modals.create_dashboard.title"),
...
mod tests {
    ...
    fn create_dashboard_title_differs_between_locales() {
        let english = dory_i18n::t!("modals.create_dashboard.title", locale = "en");
        let spanish = dory_i18n::t!("modals.create_dashboard.title", locale = "es");
