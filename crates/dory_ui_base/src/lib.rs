//! dory_ui_base — app-state-aware UI base layer.
//!
//! This crate holds types that require both `dory_app` domain knowledge and
//! GPUI integration, sitting between the pure `dory_components` layer and the
//! full `dory_ui` crate.
