...
//!
//! Wraps `SavedQueryRepo` from `dory_storage` and keeps a per-profile
...
use dory_core::{Connection, VisualQuerySpec};
use dory_storage::{SavedQueryRepo, SavedQuerySummary, error::StorageError};
use uuid::Uuid;
...
mod tests {
    use super::*;
    use dory_core::{Projection, SourceTable, VisualQuerySpec};
