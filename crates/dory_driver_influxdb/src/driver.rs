...
mod tests {
    use super::*;
    use dory_core::{DbConfig, DbDriver, InfluxVersion};
    ...
    fn build_auth_creds_v1_basic_with_user_and_password() {
        let pw = dory_core::secrecy::SecretString::new("s3cret".into());
        let creds =
    ...
    fn build_auth_creds_v1_basic_with_only_password() {
        let pw = dory_core::secrecy::SecretString::new("only-pw".into());
    ...
    fn build_auth_creds_v2_uses_token_ignores_user() {
        let tok = dory_core::secrecy::SecretString::new("influx-token".into());
        let creds =
